...
@Component({
  selector: 'app-kajal',
  templateUrl: './kajal.component.html',
  styleUrl: './kajal.component.css'
})
export class KajalComponent {
  ...
  kajalurl="https://media.istockphoto.com/id/1141688234/photo/woman-piping-decoration-on-a-cake.jpg?s=612x612&w=0&k=20&c=wq1UhFsmUcXP5q6xFfkMaqMulGMGjiXPJRAIXHP75O8=";
