...
@Component({
  selector: 'app-bhavana',
  templateUrl: './bhavana.component.html',
  styleUrl: './bhavana.component.css'
})
export class BhavanaComponent {
  ...
  bhavanaurl="https://media.istockphoto.com/id/655667546/photo/woman-decorates-homemade-cake-culinary-business.jpg?s=612x612&w=0&k=20&c=wud_GYaBqgX9k9tidcJSpQzyIRd1nmchgagycUaDwqY=";
